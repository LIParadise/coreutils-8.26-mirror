...
silent only
cd ~/Documents/coreutils-8.26-mirror
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +70 src/yes.c
badd +131 src/system.h
badd +82 lib/progname.c
badd +0 lib/long-options.c
badd +0 lib/long-options.h
argglobal
silent! argdel *
argadd src/yes.c
set stal=2
edit lib/long-options.h
...
silent! normal! zE
let s:l = 26 - ((13 * winheight(0) + 9) / 19)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 136 - ((12 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
136
